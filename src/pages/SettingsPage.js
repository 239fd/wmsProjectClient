      ...
      <Paper sx={{ p: 4, borderRadius: 4 }}>
        ...
        <Stack spacing={2} alignItems="flex-start">
          ...
          <Typography variant="caption" color="text.secondary">
            ...
            Если вы заведующий — организация, склады, товары, документы и список сотрудников будут удалены.
      ...
      <ConfirmDialog
        ...
        message={(
          <>
            ...
            {' '}Если вы заведующий — организация, склады, товары, документы и список сотрудников будут удалены без возможности восстановления.
